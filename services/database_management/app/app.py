...
import services.database_management.app.controller.orders_controller as orders_controller
...
app.add_url_rule('/update-tracking-info', methods=["POST"], view_func=orders_controller.updateTrackingInfo)
